...
void Screen_HandleSwitches(void){
    static const struct { GPIO_TypeDef* port; uint16_t pin; UiButton btn; } switchMap[] = {
        {SWITCH1_GPIO_Port, SWITCH1_Pin, BTN_RESET},
        {SWITCH2_GPIO_Port, SWITCH2_Pin, BTN_SELECT},
